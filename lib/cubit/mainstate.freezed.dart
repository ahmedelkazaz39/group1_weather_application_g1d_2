...
abstract class _Initial<T> implements MainState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$MainStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class Loading<T> implements MainState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$MainStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
abstract class Success<T> implements MainState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$MainStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'MainState<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements MainState<T> {
